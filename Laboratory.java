...
/*
	Il laboratorio è utilizzato da tre tipi di utenti (studenti, tesisti e professori) 
	...
	- I tesisti richiedono l'uso esclusivo di un solo computer, identificato dall'indice i, poiché su quel computer è installato 
	...
	L'intervallo di tempo che intercorre tra un accesso ed il successivo e l'intervallo di permanenza in laboratorio è simulato mediante il metodo sleep().
	...
	La logica di gestione del laboratorio è incapsulata all'interno di un monitor.
*/
